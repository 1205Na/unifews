...
from .gat_thr import layer_dict_gat,flops_modules_dict_gat
from .gcn2_thr import layer_dict_gcn2,flops_modules_dict_gcn2
from .gsage_thr import layer_dict_gsage,flops_modules_dict_gsage
